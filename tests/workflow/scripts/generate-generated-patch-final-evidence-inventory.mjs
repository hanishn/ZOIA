...
const SUPPORT_EVIDENCE_PATTERNS = Object.freeze([
  ...
  /^tests\/workflow\/evidence\/generated-patch-filter-runtime\/(?:prompt-graph|convert-emulator|playwright-load|filter-semantics-after-scaling|filter-semantics-after-scaling-attempt-reverted-fixed)\/run-result\.json$/u,
  /^tests\/workflow\/evidence\/generated-patch-filter-audible-sweep-after-scaling\/run-result\.json$/u,
...
const REQUIRED_LIMITATION_PHRASE_GROUPS = Object.freeze([
  ...
  ["does not prove audible cutoff sweep", "must not imply release readiness, broad text-to-ZOIA support, audible cutoff sweep success", "blocks audible cutoff-sweep claims", "audible cutoff sweep remains blocked"],
  ["does not prove hardware parity", "must not imply release readiness, broad text-to-ZOIA support, audible cutoff sweep success, unsupported non-delay runtime support, hardware export, hardware parity", "not prove hardware parity", "hardware parity"],
...
const CLAIMS = Object.freeze([
  ...
  claim("filter-modulation-trace", "Generated LFO-to-filter-cutoff route has measurable LFO/cutoff trace evidence", ["tests/workflow/evidence/generated-patch-filter-modulation-semantics/run-result.json"], "npm run zoia:test:playwright:generated-patch-filter-modulation-semantics", ["disconnected cutoff", "wrong target"], ["audible cutoff sweep"]),
  claim("audible-sweep-blocker", "Generated filter audible cutoff sweep is blocked under current CV scaling", ["tests/workflow/evidence/generated-patch-filter-audible-sweep-blocker/run-result.json"], "npm run zoia:test:playwright:generated-patch-filter-audible-sweep-blocker", ["exaggerated sweep positive detector"], ["audible cutoff sweep success"]),
  claim("non-delay-boundaries", "Reachable non-delay prompt classes have explicit runtime or blocker boundaries", ["tests/workflow/evidence/generated-patch-non-delay-boundary-controls/run-result.json"], "npm run zoia:generate:patch:non-delay-boundary-controls", ["seeded delay/filter mislabel controls"], ["reverb/synth/sequencer/MIDI/sampler runtime"]),
  claim("filter-repeatability", "Low-pass filter runtime repeats across four fresh generated filter prompt variants", ["tests/workflow/evidence/generated-patch-filter-repeatability-rollup/run-result.json", "tests/workflow/evidence/generated-patch-filter-repeatability-negative-controls/run-result.json"], "npm run zoia:generate:patch:filter-repeatability-rollup", ["stale trace", "missing trace"], ["audible cutoff sweep"]),
  claim("cv-scaling-deferral", "CV-to-filter-frequency scaling remains deferred after failed consumed-audio attempt and static recovery", ["tests/workflow/evidence/generated-patch-filter-audible-sweep-blocker/run-result.json"], "npm run zoia:test:playwright:generated-patch-filter-audible-sweep-blocker", ["static recovery", "seeded exaggerated sweep"], ["CV scaling fix"]),
