...
const MANIFEST_PATH = resolve(PROJECT_ROOT, "tests/workflow", "audio-fixtures", "q100-audio-delay-tone-fixtures.json");
const EVIDENCE_ROOT = resolve(PROJECT_ROOT, "tests/workflow", "evidence", "q100-audio-delay-tone-baseline");
