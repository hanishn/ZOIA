...
const MANIFEST_PATH = resolve(PROJECT_ROOT, "tests", "parser-harness", "fixtures", "manifests", "zoia-fixture-manifest.json");
const EVIDENCE_ROOT = resolve(PROJECT_ROOT, "tests/workflow", "evidence", "q094-all-patch-browser-baseline");
