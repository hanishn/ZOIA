...
- Promoted parser harness under `ParserHarness\zoia-parser-fixture-harness`.
- ZOIA Patch Simulator HTML under `ZOIA emulator\ZOIA_Patch_Simulator_v5_2_21_2026.html`.
...
| --- | --- | --- | --- | --- |
| ZOIA-PARSER-001 | Full promoted fixture manifest parser/model gate | Node.js | implemented | `ParserHarness\zoia-parser-fixture-harness\results\zoia-fixture-runner-result-q064-promoted-full-category-quarantined.json` |
| ZOIA-LINT-001 | No magic numbers in parser harness | Node.js | implemented | `ParserHarness\zoia-parser-fixture-harness\results\zoia-no-magic-number-lint-result-q064.json` |
