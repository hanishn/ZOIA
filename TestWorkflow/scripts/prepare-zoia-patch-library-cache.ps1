param(
  [string]$ZipPath = "G:\Projects\MusicAndMidi\ZOIA\.ZoiaLibraryApp_2_8_2026.zip",
  [string]$CacheRoot = "G:\Projects\MusicAndMidi\ZOIA\TestWorkflow\patch-library-cache\ZoiaLibraryApp_2_8_2026",
  [string]$ManifestPath = "G:\Projects\MusicAndMidi\ZOIA\TestWorkflow\patch-library-cache\zoia-patch-library-manifest.json"
)
