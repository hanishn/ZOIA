...
const Q106_RESULT_PATH = path.join(
  PROJECT_ROOT,
  "TestWorkflow/evidence/q106-community-patch-audio-classification-baseline/run-result.json",
);
const Q106_FAILURE_SUMMARY_PATH = path.join(
  PROJECT_ROOT,
  "TestWorkflow/evidence/q106-community-patch-audio-classification-baseline/failure-summary.csv",
);
...
const gates = [
  {
    ...
    args: [NPM_CLI, "--prefix", "SharedSSL/zoia-shared-ssl", "run", "verify"],
  },
  {
    id: "ssl-proof",
    command: process.execPath,
