...
const EVIDENCE_ROOT = resolve(PROJECT_ROOT, "TestWorkflow", "evidence", "q104-staged-patch-audio-all-baseline");
...
async function loadManifests() {
  ...
  for (const file of files) {
    ...
    byKey.set(`${category}/${pairId}`, {
      pairId,
      category,
      binPath: resolve(canonical.canonicalRoot, file.relativePath),
      jsonPath: jsonFile ? resolve(canonical.canonicalRoot, jsonFile.relativePath) : null,
