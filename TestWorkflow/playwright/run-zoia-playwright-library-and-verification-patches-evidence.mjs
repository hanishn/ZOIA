...
const LIBRARY_MANIFEST_PATH = resolve(PROJECT_ROOT, "TestWorkflow", "patch-library-cache", "zoia-patch-library-manifest.json");
const VERIFICATION_MANIFEST_PATH = resolve(PROJECT_ROOT, "ParserHarness", "zoia-parser-fixture-harness", "fixtures", "manifests", "zoia-fixture-manifest.json");
const EVIDENCE_ROOT = resolve(PROJECT_ROOT, "TestWorkflow", "evidence", "q095-library-and-verification-patch-baseline");
