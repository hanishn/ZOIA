...
const MANIFEST_PATH = resolve(PROJECT_ROOT, "TestWorkflow", "audio-fixtures", "q099-audio-fixtures.json");
const EVIDENCE_ROOT = resolve(PROJECT_ROOT, "TestWorkflow", "evidence", "q099-audio-fixture-baseline");
